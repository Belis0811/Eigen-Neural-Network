...
from ResNet_ENN import ResNet50 as EResNet
...
model.load_state_dict(torch.load('checkpoint_r50_cifar100.pth'))
...
log_file = open("training_log_renn_r50_cifar100_change_lr.txt", "w")
best_train = 0.0
best_val = 0.0
...
for epoch in range(num_epochs):
        ...
        if epoch % 10 == 0:
            ...
            torch.save(model.state_dict(), 'checkpoint_r50_cifar100.pth')
