...
from EResNet import ResNet50 as EResNet
...
checkpoint = 'checkpoint_r50_tiny.pth'
...
optim_conv1 = optim.SGD(list(model.conv1.parameters()) + list(model.bn1.parameters()),lr=1e-4, momentum=0.9, weight_decay=5e-4,nesterov=True)

optim_layer1 = [optim.SGD(block.parameters(), lr=1e-4, momentum=0.9, weight_decay=5e-4, nesterov=True) for block in model.layer1]
optim_layer2 = [optim.SGD(block.parameters(), lr=1e-4, momentum=0.9, weight_decay=5e-4, nesterov=True) for block in model.layer2]
optim_layer3 = [optim.SGD(block.parameters(), lr=1e-4, momentum=0.9, weight_decay=5e-4, nesterov=True) for block in model.layer3]
optim_layer4 = [optim.SGD(block.parameters(), lr=1e-4, momentum=0.9, weight_decay=5e-4, nesterov=True) for block in model.layer4]

# optim_layer1 = [optim.SGD(block.parameters(), lr=5e-4) for block in model.layer1]
# optim_layer2 = [optim.SGD(block.parameters(), lr=5e-4) for block in model.layer2]
# optim_layer3 = [optim.SGD(block.parameters(), lr=5e-4) for block in model.layer3]
# optim_layer4 = [optim.SGD(block.parameters(), lr=5e-4) for block in model.layer4]

optim_fc = optim.SGD(model.fc.parameters(), lr=1e-4, momentum=0.9, weight_decay=5e-4, nesterov=True)
...
log_file = open("training_log_renn_r50_tiny.txt", "w")
best_train = 0.0
best_val = 0.0
...
for epoch in range(num_epochs):
        ...
        if epoch % 10 == 0:
            ...
            torch.save(model.state_dict(), 'checkpoint_r50_tiny.pth')
