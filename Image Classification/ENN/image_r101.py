...
try:
    checkpoint = torch.load('checkpoint_r101_image_bp.pth')
...
log_file = open("training_log_renn_r101_image_bp.txt", "w")
best_train_acc = 0.0
best_val_acc   = 0.0
...
for epoch in range(NUM_EPOCHS):
    ...
    for i, (images, labels) in enumerate(tqdm(trainloader, desc=f"epoch {epoch+1}/{NUM_EPOCHS}")):
        ...
        if i % 10 == 0:
            ...
            torch.save(model.state_dict(), 'checkpoint_r101_image_bp.pth')
